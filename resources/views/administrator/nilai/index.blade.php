    ...
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row text-center justify-between gap-4">
            ...
            <div class="flex gap-4 items-center">
                ...
                @endif
                <a href="{{ route('admin.nilai.input.input') }}" class="btn btn-success bg-green-500 text-white rounded-lg px-4 py-2" id="addNewDataButton">Input Nilai
                    Siswa</a>
            </div>
        </div>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center">
                                    {!! $list['ganjil']
                                        ? '<a href="' .
                                            route('admin.nilai.nilai', ['siswa' => $list['id'], 'semester' => 'ganjil']) .
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center">
                                    {!! $list['genap']
                                        ? '<a href="' .
                                            route('admin.nilai.nilai', ['siswa' => $list['id'], 'semester' => 'genap']) .
                                            '" class="btn bg-blue-500 rounded-lg px-4 py-1 text-white w-fit cursor-pointer">Lihat Nilai</a>'
                                        : '<div class="btn bg-gray-500 rounded-lg px-4 py-1 text-white w-fit cursor-not-allowed">Belum Dinilai</div>' !!}
                                </div>
                            </td>
