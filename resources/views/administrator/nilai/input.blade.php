<x-app-layout>
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 dark:text-white">
        <div class="flex flex-col md:flex-row text-center justify-between gap-4">
            <h1 class="text-xl md:text-2xl font-semibold">Input Nilai Siswa</h1>
                ...
                <tbody>
                    @foreach ($dataShow as $list)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.nilai.input.siswa') }}?kelas={{ $list['id'] }}&semester=ganjil" class="btn bg-blue-500 text-white rounded-lg px-4 py-2">
                                    Lihat Data Siswa</a>
                            </td>
                        </tr>
                    @endforeach
